            ...
            },
            {
                ...
                value: function(t) {
                    ...
                    for(var M = function(t, i) {
                        ...
                        var E = void 0 === a[o][z + 1] || null === a[o][z + 1];
                        if (w.globals.isXNumeric) {
                            var Y = w.globals.seriesX[r][z + 1];
                            void 0 === w.globals.seriesX[r][z + 1] && (Y = w.globals.seriesX[r][s - 1]), n = (Y - w.globals.minX) / this.xRatio;
                        ...
                        E ? l = M(T, u) : (l = M(a[o][z + 1], u), "rangeArea" === i && (X = M(y[o][z + 1], u))), p.push(n), E && "smooth" === w.config.stroke.curve ? f.push(null) : f.push(l), b.push(X);
                        ...
                        d = R.areaPaths, c = R.linePaths, L = R.areaPath, C = R.linePath, !this.appendPathFrom || "smooth" === w.config.stroke.curve && "rangeArea" === i || (P += k.line(n, this.zeroY), I += k.line(n, this.zeroY)), this.handleNullDataPoints(a, F, o, z, r), this._handleMarkersAndLabels({
                            type: i,
                            pointsPos: F,
                            i: o,
                            j: z,
                ...
                value: function(t) {
                    ...
                    if (Array.isArray(v.config.stroke.curve) && (w = Array.isArray(x) ? v.config.stroke.curve[x[a]] : v.config.stroke.curve[a]), "rangeArea" === e && (v.globals.hasNullValues || v.config.forecastDataPoints.count > 0) && "smooth" === w && (w = "straight"), "smooth" === w) {
                        if ("rangeArea" === e ? l.length === v.globals.dataPoints : r === i[a].length - 2) {
                            ...
                            if (g += zt(S), null === i[a][0] ? u = g : u += zt(S), "rangeArea" === e && b) {
                                g += y.line(l[l.length - 1], d[d.length - 1]);
                                var C = l.slice().reverse(), L = d.slice().reverse(), P = C.map(function(t, e) {
                                    return [
                                        C[e],
                                        L[e]
                                    ];
