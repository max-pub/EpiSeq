...
import { cleanNumbers } from './lib/locations.matrix.js'
...
$('#distance #locations .matrix').addEventListener('click', () => download(`locations.dist.tsv`, TALI.grid.stringify(cleanNumbers(DATA.DIST.locations), { sortRows: true, sortCols: true, pretty: 1 })))
