...
<div class="flex-between">
	<!-- <h3>Distribution of Typing Distances</h3> -->
	<div class="limit">
		<a class=' ${xLimit == "20" ? "selected" : ""}' >20</a>
		<a class=' ${xLimit == "100" ? "selected" : ""}' >100</a>
		<a class=' ${xLimit == "500" ? "selected" : ""}' >500</a>
		<a class=' ${xLimit == "full" ? "selected" : ""}' >full</a>
	</div>
	<div class="scale-type">
		<a class="${scaleType == 'linear' ? 'selected' : ''}">linear</a>
		<a class="${scaleType == 'logarithmic' ? 'selected' : ''}">logarithmic</a>
	</div>
...
export function showTypeChart(container, data, settings = { xLimit: '500', scaleType: 'linear' }) {
	...
	let lim = settings.xLimit == 'full' ? 5000 : settings.xLimit * 1
	...
	let options = {
		...
		xTicks: tickAmount,
		yTicks: 10,
		logarithmic: settings.scaleType == 'logarithmic',
		height: '500px',
	}
